            ...
            <AnimatedSection delay={0.1} className="lg:col-span-8">
              <div className="space-y-6 font-sans text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl">
                <p>
                  ...
                  digital product design, and visual systems. For over a decade,
                  I've partnered with startups, agencies, and established brands
                  to create work that is clear, functional, and expressive.
                </p>
                <p>
                  My approach is hands-on and end-to-end. I believe the best
                  design comes from deep understanding — of the problem, the
                  audience, and the context. I work closely with clients
                  throughout the process, from early strategy through final
                  delivery.
                </p>
                <p>
                  Before going independent, I led design at several startups and
                  spent time at agencies in Paris and London. This blend of
                  perspectives shapes how I think about design: pragmatic enough
                  to ship, ambitious enough to matter.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection>
            <div className="max-w-3xl">
              <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-normal mb-8 leading-tight">
                Have a project in mind? I'm currently accepting new projects for
                Q2 2025.
              </h2>
              <Link
                to="/contact"
